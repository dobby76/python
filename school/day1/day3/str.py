...
jumin = "080804-3157673"
print("성별: "+jumin[7])
print("월: "+jumin[2:4]) # 2 ~ 3
print("일: "+jumin[4:6]) # 3 ~ 4
...
print(p[0].isupper()) # 첫글자 대문자인지
print(len(p)) # 문자열 길이
print(p.count("i")) # i가몇개 있는지
